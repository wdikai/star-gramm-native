...
export default class Users {
    ...
    @action
    async fetchUsers(isRefresh = false) {
        const previous = isRefresh ? [] : this.users;
        this.isLoading = true;
        await timeout(1000);
        this.users = previous.concat(getUsers(20, previous.length));
